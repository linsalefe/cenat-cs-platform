      ...
      <div className="space-y-8">
        ...
        >
          <div>
            ...
            <h1 className="text-3xl font-semibold text-[#27273D] tracking-tight">Cursos</h1>
          </div>
        ...
        >
          <div className="bg-white rounded-2xl p-5 border border-gray-100">
            ...
            <p className="text-2xl font-semibold text-[#27273D]">{courses.length}</p>
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100">
            ...
            <p className="text-2xl font-semibold text-[#27273D]">{totalTeachers}</p>
        ...
        >
          {filtered.length === 0 ? (
            <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-1">Nenhum curso encontrado</h3>
            ...
            filtered.map((course) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#2A658F] to-[#3d7ba8] rounded-xl flex items-center justify-center text-white font-bold text-lg flex-shrink-0">
                    {course.fullname.charAt(0)}
                  </div>

                  <div className="flex-1 min-w-0">
                    <h3 className="font-medium text-[#27273D] group-hover:text-[#2A658F] transition-colors line-clamp-1">
                      {course.fullname}
                    </h3>
                  ...
                  <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-[#2A658F] group-hover:translate-x-1 transition-all flex-shrink-0" />
                </div>
              </div>
            ))
          )}
