  ...
  return (
    <aside className="w-64 bg-[#27273D] min-h-screen flex flex-col">
      ...
      <div className="p-6 border-b border-gray-700">
        ...
        <p className="text-xs text-gray-400 mt-1">Sistema de Retenção</p>
      </div>
      ...
      <div className="p-4 border-t border-gray-700">
        ...
        <button
          onClick={logout}
          className="w-full px-4 py-2 text-sm text-red-400 hover:text-red-300 hover:bg-gray-700 rounded-lg transition-colors"
        >
          Sair
        </button>
      </div>
